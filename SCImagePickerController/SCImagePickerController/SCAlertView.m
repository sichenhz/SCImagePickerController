...
+ (instancetype)alertViewWithStyle:(SCAlertViewStyle)style {
    ...
    alertView.backgroundColor = [UIColor colorWithRed:249/255.0 green:249/255.0 blue:249/255.0 alpha:1];
...
- (UIButton *)createButton:(SCAlertAction *)action index:(NSInteger)index {
    ...
    if (action.style == SCAlertActionStyleConfirm) {
        [button setTitleColor:[UIColor colorWithRed:237/255.0 green:73/255.0 blue:73/255.0 alpha:1] forState:UIControlStateNormal];
